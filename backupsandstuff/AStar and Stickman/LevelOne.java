...
public class LevelOne extends Scene {
    ...
    public LevelOne() throws IOException, SlickException
    {
        ...
        target = new Target();
        background = new Background("res/Background/Bricks.png", 0, (int) (SCREEN_HEIGHT-(SCREEN_HEIGHT*.15)), (int) SCREEN_WIDTH, (int) (SCREEN_HEIGHT/0.95));
    ...
    public boolean drawFrame(float delta) throws IOException, LWJGLException {
